...
class TopRightWidget(QtWidgets.QWidget):
    def __init__(self, parent):
        ...
        left_area = TopRightLeftWidget(self)
        left_area.setFixedWidth(200)
        self.layout.addWidget(left_area)
        right_area = TopRightRightWidget(self)
        self.layout.addWidget(right_area)

class TopRightLeftWidget(QtWidgets.QWidget):
    def __init__(self, parent):
        super().__init__(parent)
        self.parent = parent
...
class TopRightRightWidget(QtWidgets.QWidget):
    def __init__(self, parent):
        super().__init__(parent)
        self.parent = parent
...
class TagsWidget(QtWidgets.QWidget):
    def __init__(self, parent):
        ...
        tags_label.setFixedWidth(parent.parent.tags_width)
...
class DurationWidget(QtWidgets.QWidget):
    def __init__(self, parent):
        ...
        label.setFixedWidth(parent.parent.tags_width)
...
class PortionWidget(QtWidgets.QWidget):
    def __init__(self, parent):
        ...
        portions.setFixedWidth(parent.parent.tags_width)
...
class EffortWidget(QtWidgets.QWidget):
    def __init__(self, parent):
        ...
        effort_label.setFixedWidth(parent.parent.tags_width)
...
class RatingWidget(QtWidgets.QWidget):
    def __init__(self, parent):
        ...
        self.rating_label.setFixedWidth(parent.parent.tags_width)
